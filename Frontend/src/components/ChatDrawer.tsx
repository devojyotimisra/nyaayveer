...
function formatISODateToIN(isoString: string): string {
...
const Drawer: React.FC<DrawerProps> = ({ visible, onClose, itemsData, userToken }) => {
      ...
      <FlatList
        ...
        renderItem={({ item }) => (
          <View style={styles.item}>
            ...
            >
              <Text style={styles.itemDate}>{formatISODateToIN(item.date)}</Text>
            </TouchableOpacity>
