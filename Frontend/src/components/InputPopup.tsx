...
const NewCasePopup: React.FC<InputPopupProps> = ({visible, onClose}) => {
    const {caseNumber, setCaseNumber, victimName, setVictimName, setMessages, messages, userData, userToken} = useAppContext();
    ...
    const saveChatData = async () => {
        if(userData && caseNumber && victimName){
            ...
            await saveMessages(messages, uniqueId, victimName, caseNumber, userToken);
            setVictimName('');
            setCaseNumber('');
        }
    };
